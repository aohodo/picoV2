...
class ContextProjector:
    ...
    def instructions(self):
        ...
        return (
            ...
            "For a multi-requirement coding request, use update_work_plan once to name concise delivery obligations "
            "and keep one active item; for a simple local task, keep the plan to one item. Repository graph candidates "
            "are navigation hints, not unfinished work. Treat reading as decision-directed evidence gathering, not "
            "coverage collection. Bind a discovery call to the active item with obligation_id, decision_question, "
            "and decision_effect describing how different evidence changes the action. After receiving that evidence, "
            "update the work plan with the resulting hypothesis, blocker, or candidate action before reading again. "
            "When action_readiness is ready_to_act, make the smallest coherent change and include obligation_ids plus "
            "change_hypothesis; verification should include the covered obligation_ids and expected_outcome. These "
            "fields explain the current decision; they do not grant permission or prove completion. "
